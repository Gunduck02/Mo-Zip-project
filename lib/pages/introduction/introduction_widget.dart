...
class _IntroductionWidgetState extends State<IntroductionWidget> {
  ...
  void initState() {
    ...
    _model.schoolNumberTextController ??= TextEditingController();
    _model.schoolNumberFocusNode ??= FocusNode();
    _model.schoolNumberFocusNode!.addListener(() => safeSetState(() {}));
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller:
                                            _model.schoolNumberTextController,
                                        focusNode: _model.schoolNumberFocusNode,
                                        autofocus: true,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        obscureText: false,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .schoolNumberTextControllerValidator
                                            .asValidator(context),
                                        inputFormatters: [
                                          if (!isAndroid && !isiOS)
                                            TextInputFormatter.withFunction(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadDataUns =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              ...
                                              downloadUrls.length ==
                                                  selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_uploadDataUns =
                                                  selectedUploadedFiles.first;
                                              _model.uploadedFileUrl_uploadDataUns =
                                                  downloadUrls.first;
                                            });
                                          } else {
                                            safeSetState(() {});
                          ...
                          onPressed: () async {
                            await currentUserReference!.update({
                              ...createUsersRecordData(
                                ...
                                photoUrl: _model.uploadedFileUrl_uploadDataUns,
                                phoneNumber:
                                    _model.phoneNumberTextController.text,
                                selfIntro:
                                    _model.descriptionTextController.text,
                                studentNumber:
                                    _model.schoolNumberTextController.text,
                              ),
                              ...mapToFirestore(
                                {
                                  'my_tag': _model.choiceChipsValues
                                      ?.take(5)
                                      .toList(),
                                },
                              ),
