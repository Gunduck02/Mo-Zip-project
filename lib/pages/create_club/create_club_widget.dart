...
class CreateClubWidget extends StatefulWidget {
  ...
  static String routeName = 'Create_club';
                                                    ...
                                                    child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              8.0),
                                                      child: Image.network(
                                                        'https://images.unsplash.com/photo-1576872381149-7847515ce5d8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyNHx8Ym9va3xlbnwwfHx8fDE3NzkwNTA5MDJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
                                                        width: 373.0,
                                                        height: 324.49,
                                                        fit: BoxFit.cover,
                                                      ),
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadDataL9m =
                                                                  true);
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadDataL9m =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadDataL9m =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                          } else {
                            ...
                            onPressed: () async {
                              await ClubsRecord.collection.doc().set({
                                ...createClubsRecordData(
                                  ...
                                  isCentral: _model.switchValue1,
                                  isClub: _model.switchValue1,
                                  isSomo: _model.switchValue2,
                                ),
                                ...mapToFirestore(
                                  {
                                    'manager_uid': [currentUserUid],
                                  },
                                ),
                              });
                            },
