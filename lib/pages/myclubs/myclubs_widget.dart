...
import 'myclubs_model.dart';
export 'myclubs_model.dart';

class MyclubsWidget extends StatefulWidget {
  const MyclubsWidget({super.key});

  static String routeName = 'myclubs';
  static String routePath = '/myclubs';

  @override
  State<MyclubsWidget> createState() => _MyclubsWidgetState();
}
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Align(
              ...
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 90.0, 12.0),
                child: Text(
                  '내 동아리',
                            ...
                            return Padding(
                              ...
                              child: StreamBuilder<ClubsRecord>(
                                stream: ClubsRecord.getDocument(
                                    listViewApplicationsRecord.clubRef!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                  ...
                                  final menuItemClubsRecord = snapshot.data!;
                                  ...
                                  return Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            MyClubHomeWidget.routeName,
                                            queryParameters: {
                                              'clubRef': serializeParam(
                                                menuItemClubsRecord.reference,
