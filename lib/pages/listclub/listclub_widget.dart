...
import 'listclub_model.dart';
export 'listclub_model.dart';

class ListclubWidget extends StatefulWidget {
  const ListclubWidget({super.key});

  static String routeName = 'Listclub';
  static String routePath = '/listclub';
...
class _ListclubWidgetState extends State<ListclubWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListclubModel());
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            listViewClubsRecord.thumbnailUrl,
                                            width: 80.0,
                                            height: 80.0,
                                            fit: BoxFit.cover,
                                          ),
